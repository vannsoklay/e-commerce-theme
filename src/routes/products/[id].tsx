            ...
            >
              <section class="container mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
                  <div class="col-span-1 lg:col-span-3 w-full gap-3 grid lg:grid-cols-6 ">
                    ...
                    <div class="col-span-6 block lg:hidden">
                      ...
                      <div class="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <Show
                          when={product().storeProduct.desc}
                          fallback={null}
                        >
                        ...
                        <div class="mt-3">
                          <Show
                            when={product().storeProduct.variants.length > 0}
                          >
                  ...
                  <div class="col-span-1 sm:col-span-2 hidden lg:block">
                    <div class="rating rating-sm mt-3">
                      <Show
                        when={product().storeProduct.rating}
                        fallback={null}
