...
const MobileTopBar = () => {
  ...
  return (
    <div class="btm-nav h-20 bg-white/30 z-50 xl:hidden backdrop-blur-sm">
      ...
      <A href="/cart" class="border-none bg-transparent">
        <Show
          when={
            location.pathname === "/cart" || location.pathname === "/checkouts"
          }
          fallback={
            <label class="btn-md flex justify-center btn-ghost btn-circle avatar">
              <div class="w-7 rounded-full">
        ...
        >
          ...
          >
            <div class="dropdown dropdown-top">
              ...
              >
                <li>
                  <A href={`me/@${user()?.first_name?.toLowerCase()}`} class="h-12 rounded-md flex items-center">
